...
The moon is uninhabitable by Overworld creatures due to the lack of [Oxygen](/meta/common/oxygen.md). On the other hand, alien forms of hostile mobs can spawn in the dark along with the presence of [Moon Villages](/wiki/structures/other/moon_village.md), an alien version of Overworld villages.
...
## Prerequisites
The Moon can be reached with the use of a Tier 1 Rocket, which can be built using the [NASA Workbench](/wiki/machines/space_base/nasa_workbench.md). [Rockets](/meta/common/rocket.md) of higher tiers can be used, but they are more expensive.
...
## Geological Features
### Surface
The surface of the moon is formed by craters and is covered by [Moon Turf](/wiki/blocks/natural/moon_turf.md). Underneath it there is [Moon Dirt](/wiki/blocks/natural/moon_dirt.md), and underneath that you will find [Moon Rock](/wiki/blocks/natural/moon_rock.md). In the lower levels caves with [Moon Copper Ore](/wiki/blocks/ores/moon_copper_ore.md), [Moon Tin Ore](/wiki/blocks/ores/moon_tin_ore.md) and [Cheese Ore](/wiki/blocks/ores/cheese_ore.md) will generate. The moon has no naturally occurring lava.

Sometimes you may also find [Fallen Meteors](/wiki/blocks/environment/fallen_meteor.md) on the surface of the moon.

You can also find man-made holes, which are the entrance to [Moon Dungeons](/wiki/structures/dungeons/moon_dungeon.md).
### Structures
The moon features two kinds of generated structures: [Moon Villages](/wiki/structures/other/moon_village.md) and the [Moon Dungeons](/wiki/structures/dungeons/moon_dungeon.md).

## Mobs
### Passive Mobs
The only passive entity that spawns natively and lives on the moon is the [Moon Villager](/wiki/entities/mobs/moon_villager.md). Unlike normal villagers, they cannot trade, and only walk around in their Moon Villages.

### Hostile Mobs
At night and under low light levels, [Evolved Creepers](/wiki/entities/mobs/evolved_creeper.md), [Evolved Skeletons](/wiki/entities/mobs/evolved_skeleton.md), [Evolved Zombies](/wiki/entities/mobs/evolved_zombie.md) and [Evolved Spiders](/wiki/entities/mobs/evolved_spider.md) will spawn.

### Bosses
The Moon's boss is the [Evolved Skeleton Boss](/wiki/entities/mobs/evolved_skeleton_boss.md), which is found in the [Moon Dungeons](/wiki/structures/dungeons/moon_dungeon.md).
