...
The **Overworld Space Station** is a feature added in version 0.1.23. Each space station has a dimension of its own, but has no terrain and has a greatly reduced level of gravity. Currently space stations can be created only for [The Overworld](/dimensions/celestial_bodies/overworld.md).

When this dimension is created, it only generates a small room attached to a flat platform for your [Parachest](/blocks/special/parachest.md) to land on as well as for launching a rocket. The room and platform are constructed of [Tin Decoration Blocks](/blocks/decorative/tin_decoration_block.md). The room can be expanded and built upon however you like to create your own custom space station. This station appears to be orbiting the Overworld which can be seen below the station. If you happen to fall off the station you will continue to fall to the Overworld.
...
| --- | --- |
| **Type:** | Space Station |
| **Orbits:** | [Overworld](/dimensions/celestial_bodies/overworld.md) |
| **Day-night cycle duration:** | 20min (1 Overworld day) |
| **Gravity:** | 0% |
| **Fuel Depletion:** | ? |
| **Meteor Frequency:** | 0 |
...
| **Precipitation:** | ? |
| **Solar Energy Boost:** | 100% |

## Creation
To create a space station, fly your [Tier 1](/entities/vehicles/tier_1_rocket.md) or [Tier 2 Rocket](/entities/vehicles/tier_2_rocket.md) to space. You will then be given the option to create a space station in the [Planet Selection Screen](/concepts/general/planet_selection_screen.md) so long as you have the required materials in your inventory (required materials listed below).

The components below will assemble a basic space station comprised of a small main room with the roof and corners built, a platform where you can place a [Rocket Launch Pad](/machines/pads/rocket_launch_pad.md), and a [Parachest](/blocks/special/parachest.md) containing your [rocket](/common/rocket.md) and a small amount of left-over fuel that can be collected using an [Empty Canister](/items/liquids_gases/empty_canister.md). The station does not have any sort of [oxygen](/common/oxygen.md) or other life support so you should [prepare accordingly](/tutorials/oxygen.md).

Some recommended supplies include:
* [Oxygen Mask](/items/life_support/oxygen_mask.md), [Oxygen Gear](/items/life_support/oxygen_gear.md), and [Oxygen Tanks](/common/oxygen_tank.md)
* Food and building materials
* [Oxygen Collectors](/machines/oxygen_collector.md), [Oxygen Distributors](/machines/oxygen_bubble_distributor.md), and [Oxygen Compressors](machines/oxygen_compressor.md)
* Trees, wheat, or other source to collect oxygen from

It is recommended that you read the [oxygen tutorial](/tutorials/oxygen.md).
...
After you have made the Space Station you may want to add some [Oxygen Sealers](/machines/oxygen_sealer.md) and [Oxygen Distributors](/machines/oxygen_bubble_distributor.md) and some [Air Locks](/concepts/general/air_lock.md).

### Galacticraft 2+
* 16 [Aluminum Ingots](/items/materials/aluminum_ingot.md)
* 32 [Tin Ingots](/items/materials/tin_ingot.md)
* 24 [Iron Ingots](/items/materials/iron_ingot.md)
* 1 [Advanced Wafer](/items/manufactured/advanced_wafer.md)

### Galacticraft 1
If you are still using the old Galacticraft, the materials required to create a space station depend on the prerequisite mod you installed, either IndustrialCraft 2, Thermal Expansion or [Basic Components](/general/basic_components.md).
* **Thermal Expansion**
  * 16 [Tin Ingots](/items/materials/tin_ingot.md)
  * 24 Invar Ingots
  * 8 [Copper Ingots](/items/materials/copper_ingot.md)
  * 1 Redstone Reception Coil
* **IndustrialCraft 2**
  * 1 Machine Block
  * 24 [Tin Ingots](/items/materials/tin_ingot.md)
  * 12 [Iron Ingots](/items/materials/iron_ingot.md)
* **Basic Components**
  * 16 [Steel Ingots](/items/materials/steel_ingot.md)
  * 24 [Iron Ingots](/items/materials/iron_ingot.md)
  * 32 [Tin Ingots](/items/materials/tin_ingot.md)
...
[Advanced Solar Panels](/machines/power/advanced_solar_panel.md) can collect a small amount light during this "extended" daylight time whereas it is night on the Overworld.
...
### Gravity Changes
In addition to the introduction of [Spin Thrusters](/machines/space_base/spin_thruster.md) and G-Force, Galacticraft 3 also changed the way gravity works while on a Space Station. It's a Minecraft first and we think it's rather cool! Some players will find it **hard to move around in space** though...
...
*For commands related to space stations, refer to [Commands#Permission_nodes](/setup/commands.md#permission-nodes).*
